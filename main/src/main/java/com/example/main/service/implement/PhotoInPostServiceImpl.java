...
import com.example.main.exeption.PhotoNotFoundException;
import com.example.main.model.PhotoInPosts;
import com.example.main.repository.repositoryJPA.PhotoInPostRepository;
import com.example.main.repository.repositoryJPA.PostsRepository;
import com.example.main.service.interfaces.PhotoInPostService;
import com.example.main.utils.FileUploadUtil;
...
public class PhotoInPostServiceImpl implements PhotoInPostService {
    ...
    public PhotoInPosts createPhotoInPost(Long postId, PhotoInPosts photoInPosts, MultipartFile multipartFile) throws IOException{
        try {
            ...
            String uploadDir = Paths.get("server/main/src/main/resources/static")
